...
declare namespace c {
    ...
    interface IUtil {
         ...
         */
        setModuleDefaults(moduleName:string, defaults:any, version?:string): any;

        /**
         * This allows module developers to retrieve the configuration for the module as a Config instance
         */
        getModuleConfig(moduleName:string, overrides:any, version?:string): IConfig;
    }
